...
public class JazzyViewPager extends ViewPager {
	...
	public JazzyViewPager(Context context, AttributeSet attrs) {
		...
		setFadeEnabled(ta.getBoolean(R.styleable.JazzyViewPager_fadeEnabledPager, false));
		setOutlineEnabled(ta.getBoolean(R.styleable.JazzyViewPager_outlineEnabledPager, false));
		setOutlineColor(ta.getColor(R.styleable.JazzyViewPager_outlineColorPager, Color.WHITE));
		switch (mEffect) {
		case Stack:
		case ZoomOut:
			setFadeEnabled(true);
...
//		mRight = getChildAt(position+1);
	...
	private static class MyHandler extends Handler {
		...
		private final WeakReference<JazzyViewPager> autoScrollViewPager;

		public MyHandler(JazzyViewPager autoScrollViewPager) {
			this.autoScrollViewPager = new WeakReference<JazzyViewPager>(autoScrollViewPager);
		}
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case SCROLL_WHAT:
					JazzyViewPager pager = this.autoScrollViewPager.get();
					if (pager != null) {
